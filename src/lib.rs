            ...
            if let EdgeLabel::Branch(branch) = label {
                ...
                if branch_name.contains("/tags/") {
                    ...
                    if  succ_type != NodeType::Release {
                        ...
                        insert_tag(&mut tags, succ, branch_name, graph);
                        continue;
                    }
                    ...
                    if revs.len() == 1 {
                        ...
                        insert_tag(&mut tags, rev, branch_name, graph);
                    } else {
...
fn insert_tag<G: SwhFullGraph>(
    tags: &mut HashMap<String, (usize, i64, Option<usize>)>,
    rev: usize,
    branch_name: String,
    graph: &G,
) {
